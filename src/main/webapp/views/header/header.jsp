  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
      ...
      <div class="collapse navbar-collapse" id="navbarNav" style="margin-right: 100px; justify-content: end">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link" href="profile">Tài khoản<span><i class="bi bi-person-circle"
                  style="font-size: 20px; margin-left: 10px"></i></span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="cart">Giỏ hàng
              <span><i class="bi bi-cart-fill" style="font-size: 20px; margin-left: 10px"></i></span></a>
          </li>
        </ul>
      </div>
    </nav>
