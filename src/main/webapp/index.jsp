    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
      ...
      <head>
        ...
        <style>
          .product-card {
            min-height: 490px;
            /* Đặt chiều cao tối thiểu cho sản phẩm */
          }
        </style>
            ...
            <div id="bannerCarousel" class="carousel slide mb-3" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active" data-interval="2000">
                  <img src="${pageContext.request.contextPath}/views/images/banner1.jpg" alt="Banner1"
                    class="d-block w-100 img-fluid" />
                </div>
                <div class="carousel-item" data-interval="2000">
                  <img src="${pageContext.request.contextPath}/views/images/banner2.jpg" alt="Banner2"
                    class="d-block w-100 img-fluid" />
                </div>
                <div class="carousel-item" data-interval="2000">
                  <img src="${pageContext.request.contextPath}/views/images/banner3.jpg" alt="Banner3"
                    class="d-block w-100 img-fluid" />
                </div>
              </div>
                    ...
                    <div class="d-flex justify-content-between ml-5 mr-5">
                      <c:if test="${not empty entry.value}">
                        ...
                        <div role="button" class="fs-4">
                          <a
                            href="${pageContext.request.contextPath}/web/product?categoryId=${entry.value.get(0).getCategoryId()}">Xem
                            tất cả</a>
                        </div>
                      </c:if>
                    </div>
                    <div class="d-flex justify-content-center">
                      <c:forEach var="product" items="${entry.value}">
                        <div class="col-md-2 mb-4" role="button">
                          <div class="card rounded-2 product-card d-flex align-items-stretch">
                            ...
                            <div class="card-body d-flex flex-column align-items-stretch">
                              ...
                              <c:choose>
                                <c:when test="${empty role}">
                                  <button class="btn btn-warning btn-block" onclick="showLoginAlert()">Thêm vào giỏ
                                    hàng</button>
                                </c:when>
                                <c:otherwise>
                                  <form method="post" action="${pageContext.request.contextPath}/cart">
                                    ...
                                    <div class="input-group mb-3 justify-content-center">
                                      ...
                                      <input type="number" name="quantity" class="text-center" value="1" min="1"
                                        max="99">
